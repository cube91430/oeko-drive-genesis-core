    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-card py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-card-foreground mb-4">Research</h1>
          <div className="flex items-center justify-center space-x-2 text-sm text-muted-foreground mb-8">
            <span>Home</span>
            <span>/</span>
            <span className="text-moss-medium">Research</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-card-foreground">
              <span className="text-moss-medium">Research Services</span> We Provide
            </h2>
          </div>
